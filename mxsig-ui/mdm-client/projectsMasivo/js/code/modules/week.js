	...
	var _obj = {
			...
			createWeekList:function(){
				...
				var cadena = '<div id="week_list_header" class="week-list-header">';
					...
					cadena+= '		<div class="week-list-header-name"><big>Planeación Semanal</big></br><b>'+user.alias+'</b></br>'+user.userName+'</div><div id="week_list_header_charge" class="week-list-header-charge"></div>';
					cadena+= '	</div>';
					cadena+= '</div>';
