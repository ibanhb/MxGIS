// JavaScript Document
window.layerWidgets.ccnago_catastro.config = {
		    settings:{
				 project:'mxsig',
				 ...
				 varByLevel:{  //indicadores precargados con los que se tematizará al seleccionar un corte geográfico al inicio
					 lv1:{
						...
						parent:97,
						idTab:98,
						censo:"Censo Nacional de Gobiernos Municipales y Delegacionales",
						subtitle:"Tipo de área con la que cuenta la institución o unidad administrativa"
					 },
					 nal:{
						descripcion:"Área administrativa",
						id:13,
...
window.layerWidgets.ccnago_catastro.widgetLoaded = true;
