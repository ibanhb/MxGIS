$.widget( "custom.cfepade", {
  ...
  _create: function() {
	...
	obj.loadConfiguration(function(geoLevels){
			...
			setTimeout(function(){  //abre la configuración
				obj.openConfig();
				setTimeout(function(){
					$("#cfepade_geo_content").Popup({content:'Seleccione una entidad para comenzar',showOn:'now',highlight :false,time:6000});
				},1500);
			},1500);
			...
			obj.element
			  ...
			  .addClass( "custom-cfepade toolCustomIdentify cfepade-animated" ).attr('collapsed','true').attr('seltab','geo').attr('changed','false').attr('geotype',obj.currentData.geoType)
			  .attr('infopanel','data')
  ...
  //------------------------
	updateRampStrat:function(){
		...
		var cadena = '';
		cadena += '<div class="cfepade-header-colors-years-label"><div id="cfepade-year-min" class="cfepade-header-year-label-left"></div><div id="cfepade-year-max" class="cfepade-header-year-label-right"></div></div>';

		var colors = obj.currentData.colors.colors;
		for (var x in colors) {
			if(parseInt(x,10) < strats){
				var color = colors[x];
				cadena += '<div class="cfepade-header-colors-item" style="background-color:' + color + ';width:' + Math.floor(100 / strats) + '%"></div>';
			}
		}
		cadena += '</div>';
		
		$('#cfepade_color_container').html(cadena);
   ...
   createUI:function(){
	  ...
	  var cd = obj.currentData;  
	  obj.printGeoList();
	  var 	cadena = '<div id="cfepade_header" class="cfepade-header cfepade-resize cfepade-transition">';
			cadena+=	'<div id="cfepade_header_click_collapsed"></div>';
	   		cadena+=	'<div id="cfepade_header_logoLeft" idref="" class="cfepade-logo-left"></div>';
	   		cadena+=	'<div id="cfepade_header_title" class="cfepade-truncate-text"><div id="cfepade_var_title">Seleccione una variable</div><div id="cfepade_subvar_title_container"><div id="cfepade_subvar_title"></div></div></div>';
	   		cadena+=	'<div class="cfepade-header-btns">';
	   		cadena+=	'	<div id="cfepade_header_btnRight" idref="" class="cfepade-header-btn">';
			cadena+=	'		<div id="cfepade_header_btnRight_modify" idref="" class="cfepade-header-btn-inner sprite-cfepade sprite-cfepade-modify"></div>';
	   		cadena+=	'		<div id="cfepade_header_btnRight_ok_nm" idref="" class="cfepade-header-btn-inner sprite-cfepade sprite-cfepade-down"></div>';
			cadena+=	'		<div id="cfepade_header_btnRight_ok_n" idref="" class="cfepade-header-btn-inner sprite-cfepade sprite-cfepade-down"></div>';
	   		cadena+=	'	</div>';
	   		cadena+=	'	<div id="'+obj.id+'_header_btnRight_close" idref="" class="cfepade-header-btnRight-close cfepade-header-btn-inner sprite-cfepade sprite-cfepade-info"></div>';
	   		cadena+=	'</div>';
			cadena+=	'<div class="cfepade-header-colors" id="cfepade_color_container">';
	   		/*cadena+=	'<div class="cfepade-header-colors-years-label"><div id="cfepade-year-min" class="cfepade-header-year-label-left"></div><div id="cfepade-year-max" class="cfepade-header-year-label-right"></div></div>';

			var colors = obj.currentData.colors.colors;
	   		for(var x in colors){
				var color = colors[x];
				cadena+=	'<div class="cfepade-header-colors-item" style="background-color:'+color+';width:'+Math.floor(100/colors.length)+'%"></div>';
			}
	   
			cadena+=	'</div>';*/
	   
	  		cadena+= '	</div>';
			cadena+= '<div id="cfepade_panels_container" class="cfepade-panels-container cfepade-animated" panel="vars" style="padding-top:2px";>';
	   		cadena+= '	<div id="cfepade_container" class="cfepade-container cfepade-tab-container" parents="false" typeselection="'+obj.currentData.typeVarSelection+'">';

	   		/*cadena+= '		<div id="cfepade_geo_content_options" class="cfepade-geo-content-options cfepade-resize cfepade-animated">';
			cadena+= '			<div idref="edomun" id="cfepade_tool_total" class="cfepade-tool-option cfepade-tool-total">TOTAL</div>';
	   		cadena+= '			<div idref="edo" id="cfepade_tool_edo" class="cfepade-tool-option cfepade-tool-total">EDO</div>';
	   		cadena+= '			<div idref="mun" id="cfepade_tool_mun" class="cfepade-tool-option cfepade-tool-total">MUN</div>';
			cadena+= '		</div>';*/
			
	   		cadena+= '	<div id="cfepade_content" class="cfepade-resize cfepade-animated cfepade-content"></div>';
	   		cadena+= '	<div id="cfepade_bk_btn" class="cfepade-resize cfepade-animated cfepade-bk-btn"><div class="cfepade-bk-btn-icon sprite-cfepade sprite-cfepade-bback"></div></div>';
			cadena+= '	</div>';
	   		cadena+= '	<div id="cfepade_geo_container" class="cfepade-geo-container cfepade-tab-container">';
			cadena+= '		<div id="cfepade_geo_bk_btn" class="cfepade-resize cfepade-animated cfepade-geo-bk-btn"><div class="cfepade-geo-bk-btn-icon sprite-cfepade sprite-cfepade-bback"></div></div>';
	   		cadena+= '		<div id="cfepade_geo_content" class="cfepade-resize cfepade-animated cfepade-geo-content"></div>';
	   		cadena+= '		<div id="cfepade_geo_type" class="cfepade-resize cfepade-animated cfepade-geo-type">';
			cadena+= '		</div>';
			cadena+= '	</div>';
	   		cadena+= '	<div id="cfepade_conf_container" class="cfepade-conf-container cfepade-tab-container">';
			cadena+= '		<div id="cfepade_conf_content" class="cfepade-resize cfepade-animated cfepade-conf-content"></div>';
			cadena+= '	</div>';
	   		cadena+= '	<div id="cfepade_info_container" class="cfepade-info-container cfepade-tab-container">';
			cadena+= '		<div id="cfepade_info_content" class="cfepade-resize cfepade-animated cfepade-info-content"></div>';
	   		cadena+= '		<div id="cfepade_info_tabulated" class="cfepade-resize cfepade-animated cfepade-info-tabulated"></div>';
	   		cadena+= '		<div id="cfepade_info_graph" class="cfepade-resize cfepade-animated cfepade-info-graph"></div>';
			cadena+= '	</div>';

			cadena+= '	<div id="cfepade_tutorial_container" class="cfepade-tutorial-container cfepade-tab-container cfepade-about-container">';
			cadena+= '		<div id="cfepade_info_content" class="cfepade-resize cfepade-animated cfepade-info-content">'
			cadena+= '	</div>';
			cadena+= '</div>';

			/*cadena+= '<div id="cfepade_info_container" class="cfepade-info-container cfepade-tab-container">';
			cadena+= '		<div id="cfepade_info_content" class="cfepade-resize cfepade-animated cfepade-info-content"></div>';
	   		cadena+= '		<div id="cfepade_info_tabular" class="cfepade-resize cfepade-animated cfepade-info-graph"></div>';
			cadena+= '	</div>';*/
	   		cadena+= '</div>';
	   
	   		cadena+= '<div id="cfepade_toolbar_container" class="cfepade-toolbar-container cfepade-animated">';
	   		cadena+= '	<div id="cfepade_tab_geo" idref="geo" class="cfepade-resize cfepade-tab"><div class="sprite-cfepade-globe"></div><div>Geográfico</div></div>';
	   		cadena+= '	<div id="cfepade_tab_vars" idref="var" class="cfepade-resize cfepade-tab"><div class="sprite-cfepade-vars"></div><div>Indicador</div></div>';
	   		cadena+= '	<div id="cfepade_tab_graph" idref="graph" class="cfepade-resize cfepade-tab"><div class="sprite-cfepade-graph"></div><div>Estratos</div></div>';
			cadena+= '	<div id="cfepade_tab_info" idref="info" class="cfepade-resize cfepade-tab"><div class="sprite-cfepade-binfo"></div><div>Detalle</div></div>';
			cadena+= '	<div id="cfepade_tab_tutorial" idref="tutorial" class="cfepade-resize cfepade-tab"><div class="sprite-ecoTool-babout"></div><div>Metodología y manual</div></div>';
	   		/*cadena+= '	<div id="cfepade_tab_bottom_container" idref="_info" class="cfepade-tab-bottom-container cfepade-animated">';
			cadena+= '		<a href="'+obj.settings.mainDoc+'" target="_blank"><div id="cfepade_tab_pdfdoc" idref="pdfdoc" class="cfepade-resize sprite-cfepade-doc-pdf"></div></a>';
			cadena+= '	</div>';*/
			
			//cadena+= '	<div id="cfepade_tab_about" idref="about" title="Metodología y aviso" class="agropecuario-resize agropecuario-tab sprite-agropecuario-babout"></div>';
	   		cadena+= '	<div class="cfepade-disable-toolbars"></div>';
			cadena+= '</div>';
	  ...
	  //obj.updateRampStrat(); 
	   ...
	   $('.cfepade-tool-option').each(function(){
		  $(this).click(function(){
			 var idref = $(this).attr('idref');
			 
			 if(idref != obj.currentData.typeVarSelection){
				obj.hasChanged = true;	  
				$('#cfepade_container').attr('typeselection',idref);
	   ...
	   $('#cfepade_header_click_collapsed').click(function(){
			$('#cfepade_header_btnRight').click();	   
	   });
	  ...
	  $('#cfepade_header').click(function(e){
			  if($('#cfepade_panels_container').height() == 0){
				//obj.openConfig();
				e.stopPropagation();
			  }
   	 });
	  ...
	  $('#cfepade_header_btnRight').click(function(){
		  if($('#cfepade_panels_container').height() == 0){
			obj.openConfig();
		  }else{
			obj.closeConfig();
	   ...
	   $('#cfepade_geo_bk_btn').click(function(){
	   ...
	   $('#cfepade_bk_btn').click(function(){
		   if(obj.currentData.tree.length > 1){
			  obj.currentData.tree.pop();
			  if(obj.currentData.tree.length <= 1){
				  $('#cfepade_container').attr('parent','false');
			  }
...
//print geoTypes
 printGeoTypes:function(){
	...
	for(var x in list){
		...
		cadena+= '<div idref="'+sItem.id+'" class="cfepade-geotype-item '+isSelected+'">'+sItem.label+'</div>';
	}
	

	$('#cfepade_geo_type').html(cadena);
	$('.cfepade-geotype-item').each(function(){
		$(this).click(function(){
			if(canBeSelected()){
				var idref = $(this).attr('idref');
				obj.currentData.currentMapTheme = idref;
				$('.cfepade-geotype-item.selected').removeClass('selected');
 ...
 //--------- Vars Display-----------------------------------------------------------------
		  ...
		  obj.getData(dataSource,params,function(data){
			  ...
			  if(data.data && data.data.data){
				  ...
				  for(var x in list){
				   ...
				   $('#cfepade_container').attr('parent','false');
				   if(obj.currentData.tree.length > 1){
						$('#cfepade_container').attr('parent','true');
				   }
  ...
  updateHeader:function(){
	...
	$('#cfepade_var_title').html(_var.descripcion);
...
//	$('#cfepade_subvar_title').html(svars.join('/')+' '+endText);

	$('#cfepade_subvar_title').html(svars.join('<br/>'));
  ...
  printItemList:function(list){
	  ...
	  var count = 0;
	   for (var x in list){
		   ...
		   var condition=(item.filters && item.filters.length>0 && item.filters[0].value=="no")?item.variable+"_no":item.variable;
		   
			cadena+= '<div class="cfepade-list-item" idref="'+item.id+'"><label class="cfepade-info-grid-container-icons">';
		   
		   if(item.metadata)
			cadena+= '	<span idref="'+condition+'" class="cfepade-info-var-icon sprite-cfepade-info"></span>';
			
		    cadena+= 	item.descripcion+'</label>';

			if(canSelect){
				if(!active){
					cadena+= '	<div idref="'+item.id+'" class="cfepade-item-check sprite-cfepade sprite-cfepade-circle"></div>';   
				}else{
					cadena+= '	<div idref="'+item.id+'" class="cfepade-item-check sprite-cfepade sprite-cfepade-ok"></div>';   
				}
			}
			obj.findCurrentValue();
			
			if(item.subcat){
				cadena+= '<div idref="'+item.id+'" class="cfepade-item-forward sprite-cfepade sprite-cfepade-forward"></div>';   
				obj.findCurrentValue();
			}
			cadena+= '</div>';
	   }
	   $('#cfepade_content').html(cadena);
	  
	   $('.cfepade-info-var-icon').each(function(){
		  $(this).click(function(){
			  var idref = $(this).attr('idref');
	   ...
	   $('.cfepade-item-check').each(function(index, element) {
		   $(this).click(function(e){
				var idref = $(this).attr('idref');
				obj.selectVar(idref);
				e.stopPropagation();
	   ...
	   $('.cfepade-item-forward').each(function(index, element) {
		   $(this).click(function(e){
				var idref = $(this).attr('idref');
	 ...
	 var printList = function(list){
		if(list.length > 0){
			...
			for(var x in list){
					...
					$('#cfepade_geo_container').attr('parent',isChild);
				
					var isSelected = (obj.currentData.geoSelected.indexOf(item.cvegeo) >= 0);
					cadena+= '<div class="cfepade-geoEdo-item" label="'+item.nombre.toLowerCase()+'" idparent="'+parent+'"  idref="'+item.cvegeo+'" '+((isSelected)?'selected="selected"':'')+'>';
					cadena+= '	<div class="cfepade-geoEdo-item-label">'+item.nombre+'</div>';
					cadena+= '	<div class="cfepade-geoEdo-icon" idref="'+item.cvegeo+'">';
					cadena+= '		<div class="cfepade-geoEdo-icon-sel sprite-cfepade-circle"></div>';
					cadena+= '		<div class="cfepade-geoEdo-icon-unsel sprite-cfepade-ok"></div>';
					cadena+= '	</div>';
					
					//comentado VER MAS...
					if(item.childs){ //preenta icono de avanzar solo cuando llega hasta nivel de municipio
						cadena+= '	<div idref="'+item.cvegeo+'" class="cfepade-geo-seemore">';
						cadena+= '		<div idref="'+item.cvegeo+'"class="cfepade-geoEdo-icon-seemore sprite-cfepade-forward"></div>';
						cadena+= '	</div>';
					}
					cadena+= '</div>';
			 }
			$('#cfepade_geo_content').html(cadena);
			
			$('.cfepade-geoEdo-icon').each(function(){
				$(this).click(function(e){
					var idref = $(this).attr('idref');
					obj.currentData.strats = 3; 
					obj.currentData.geoLevelActive = (idref == '00')?'nal':obj.currentData.geoLevel+1;
					obj.selGeoItem(idref);
					e.stopPropagation();
				})
			});
			$('.cfepade-geo-seemore').each(function(index, element) {
			   $(this).click(function(e){
					var idref = $(this).attr('idref');
...
spinner:function(option){
	var obj = this;
	if(option == 'show'){
		if(!$('#cfepade_spinner_panel').attr('id')){
			var w = obj.element.width();
			var h = obj.element.height();
			var cadena = '<div id="cfepade_spinner_panel" class="cfepade-spinner-panel" count="1" style="width:'+w+'px;height:'+h+'px">';
				cadena+= '	<div class="ui-widget-overlay cfepade-block-overlay"></div>';
				cadena+= '	<div class="cfepade-spinner-image-container"><span class="cfepade-spinner-image"></div>';
				cadena+= '<div>';

			obj.element.append(cadena);	
		}else{
			var count = parseInt($('#cfepade_spinner_panel').attr('count'),10);
			$('#cfepade_spinner_panel').attr('count',count+1);
...
printThemeDetail:function(){
	...
	for(var x in strats){
		...
		var color = colors[x];
		cadena+='<div idstrat="'+strat.stratum+'" class="cfepade-strat-item-selector '+((x=='0')?'selected':'')+'" style="width:'+w+'%">';
		cadena+='	Estrato '+strat.stratum;
		cadena+='	<span class="cfepade-strat-selector-color" style="background-color:'+color+'">';//style="background-color:rgb('+strat.rgb.split(' ').join()+')">';
		cadena+='</div>';
	}
	
		cadena+= '<div class="cfepade-strat-table-container">';
		cadena+= '	<table id="cfepade_strat_table" class="cfepade-strat-table" strat="e1" width="100%">';
		cadena+= '	<tr class="cfepade-table-head"><td>'+geoType+'</td><td align="right">Valor</td></th></tr>';
	...
	cadena+='<div class="cfepade-strat-table-export-container">';
	//Salto a grafica
	cadena+='<div id="cfepade_switchtograph_btn" class="cfepade-switchtograph-btn sprite-cfepade-graph-mini"></div>';
	cadena+='<div id="cfepade_switchtotabular_btn" class="cfepade-switchtograph-btn sprite-cfepade-grid"></div>';
	
	var exportList = obj.settings.exportTypes;
	for(var x in exportList){
		cadena+='<div idref="'+exportList[x]+'" class="cfepade-export-type-item sprite-cfepade-doc-'+exportList[x]+'"></div>';
	}
	cadena+='</div>';
	
	
	$('#cfepade_info_content').html(cadena);
	
	
	//area de grafica
	cadena = '<div id="cfepade_info_graph_container" class="cfepade-info-graph-container"></div>'
	cadena+=' <div id="cfepade_switchtodata_btn" class="cfepade-switchtograph-btn sprite-cfepade-sleft"></div>';
	$('#cfepade_info_graph').html(cadena);

	//area de tabulated
	cadena = '<div id="cfepade_info_tabulated_container" class="cfepade-info-tabulated-container">Error</div>'
	cadena+='<div class="cfepade-strat-table-export-container">';
	cadena+='<div id="cfepade_switchtodatatabulated_btn" class="cfepade-switchtograph-btn sprite-cfepade-sleft"></div>';
	cadena+='<div idref="xls" class="cfepade-switchtograph-btn cfepade-export-type-item-tabulated sprite-cfepade-doc-xls"></div>';
	cadena+='<div idref="csv" class="cfepade-switchtograph-btn cfepade-export-type-item-tabulated sprite-cfepade-doc-csv"></div>';
	cadena+='</div>';

	obj.loadTabulated();

	$('#cfepade_info_tabulated').html(cadena);

	//area de Tabular
	$('#cfepade_info_tabular').html(cadena);

	
	$('#cfepade_switchtograph_btn').click(function(){
		$('#'+obj.id).attr('infopanel','graph');
	});

	$('#cfepade_switchtodatatabulated_btn').click(function(){
		$('#'+obj.id).attr('infopanel','data');
	});

	
	$('#cfepade_switchtotabular_btn').click(function(){
		$('#'+obj.id).attr('infopanel','tab');	
	});
	

	$('#cfepade_switchtodata_btn').click(function(){
		$('#'+obj.id).attr('infopanel','data');
	});
	
	
	$('.cfepade-export-type-item').each(function(){
		$(this).click(function(){
			var idref = $(this).attr('idref');
	...
	$('.cfepade-export-type-item-tabulated').each(function(){
		$(this).click(function(){
			var idref = $(this).attr('idref');
	...
	$('.cfepade-strat-item-selector').each(function(){
		$(this).click(function(){
			var idstrat = $(this).attr('idstrat');
			$('.cfepade-strat-item-selector.selected').removeClass('selected');
			$(this).addClass('selected');
			$('#cfepade_strat_table').attr('strat','e'+idstrat);
		});
	});
	
	//Print min max
	obj.updateRampStrat();
	$('#cfepade-year-min').html(obj.formatMoney(theme.min)); //using sugar format
	$('#cfepade-year-max').html(obj.formatMoney(theme.max));
	  //cfepade-year-max
...
//print panel config
  createRampColor:function(ramp){
		...
		var cadena= '<div idref="'+ramp.id+'" class="cfepade-strats-colorRamp" '+((currentRamp.id == ramp.id)?'selected="selected"':'')+'>';
			for(var x in colors){
				var width = 100/snum;
				cadena+='<div class="cfepade-strats-ramp-color" style="background-color:'+colors[x]+';width:'+width+'%"></div>';	
			}
			cadena+='</div>';
		return cadena; 
 },
 printConfig:function(){
	 ...
	 if(cd.theme){	//si hay tema para desplegar
			 cadena+= '<div id="'+obj.id+'_graph_strat'+'" class="cfepade-graph-strat"></div>'; 
			 cadena+= '<div class="cfepade-strats-transparency-container">';
			 cadena+= '		<div class="cfepade-strats-transparency-title">Transparencia</div>';
			 cadena+= '		<div id="cfepade_strats_trasparencyControl" class="cfepade-strats-transparency-tool"></div>';
			 cadena+= '</div>';

			 cadena+= '<div class="cfepade-theme-normalInfo cfepade-theme-info">';
			 ...
			 cadena+= '<div class="cfepade-theme-mainInfo cfepade-theme-info">';
			 ...
			 cadena+=	'<div class="cfepade-strat-method cfepade-animated">';
			...
			var methods = obj.settings.methods; //print methods
			 ...
			 for(var x in methods){
				...
				cadena+=	'<div style="width:'+widthMethod+'%" val="'+method.name+'" class="cfepade-strat-item '+((method.name == cd.method)?'selected':'')+'">'+method.title+'</div>';
			 }
			 cadena+=	'</div>';
		   ...
		   var maxStrats = obj.settings.maxStrats;
			...
			cadena+= '	<div class="cfepade-strats-strat-title">No.Estratos</div>';
			cadena+= '	<div id="cfepade_strats_data_config_strats" class="cfepade-strats-data-config-strats">';
					   for(var x = minStrats; x <= maxStrats;x++){
							cadena+= '<div idref="'+x+'" class="cfepade-strats-strat-item '+((x == cd.strats)?'selected':'')+'">'+x+'</div>';
					   }
			cadena+= '	</div>';


		/*	 cadena+=	'<div class="cfepade-years cfepade-animated">';
			 cadena+=	'	<div class="cfepade-years-title">Año</div>';

			 var years = obj.settings.years;  
			 for(var x in years){
				var year = years[x];
				cadena+=	'<div val="'+year+'" class="cfepade-years-item '+((year == cd.year)?'selected':'')+'">'+year+'</div>';
			 } 
			 cadena+=	'</div>';*/


			//cadena+=	'<div class="cfepade-config-titles"><label></label></div>'; 
			cadena+=	'<div class="cfepade-strats-currentRamps-container">';
	 ...
	 $('#cfepade_conf_container').html(cadena);
	 
	$('.cfepade-strats-strat-item ').each(function(index, element) {
		$(this).click(function(e){
			$('.cfepade-strats-strat-item.selected').removeClass('selected');
			$(this).addClass('selected');
	 ...
	 $( "#cfepade_strats_trasparencyControl" ).slider({
		  range: "max",
		  min: 1,
		  max: 100,
	 ...
	 $('.cfepade-strats-colorRamp').each(function(){
			$(this).click(function(){
				
				$('.cfepade-strats-colorRamp[selected=selected]').each(function(index, element) {
	 ...
	 $('.cfepade-strat-item').each(function(index, element) {
      		/*$(this).click(function(){
				var val = $(this).attr('val');
				$('.cfepade-strat-item.selected').removeClass('selected');
				$(this).addClass('selected');
	 ...
	 /* $('.cfepade-years-item').each(function(index, element) { 
      		$(this).click(function(){
				var val = $(this).attr('val');
				$('.cfepade-years-item.selected').removeClass('selected');
				$(this).addClass('selected');
...
//---------------------------------------------------------------------	
  getData:function(source,params,callback,error,before,complete){
	...
	prepareTheme:function(){
		...
		var filters =  cData.varActive.filters;
		var geoLevels = obj.options.config.settings.geoLevels;
		//tema actual;
		var currentMapTheme = obj.currentData.currentMapTheme;
		if(obj.backupData != null){
		    ...
		    cData.currentMapTheme = (isNal)?'fepadeentidad':'fepadedistrito';
			var params = {
			...
			obj.getData(dataSource,params,function(data){
					...
					if(data.response.success){
						...
						if(!data.response.success && data.response.message == '409' && obj.currentData.strats > 1){ //409 intentar con menos estratos
							...
							if(!data.response.success && data.response.message != '409'){
								obj.options.systemMessage( data.response.message,{width:240,height:120,title:'Información'});
							}
	...
	clearThemeLayer:function(){
		...
		themeParams['MAPADISTRITO'] = 0;//(cData.geoType == 'mun')?idTheme:0;;
  ...
  // Exportz|
   ...
   // Exportz|
			...
			if(obj.currentData.tree.length > 1){
			  ...
			  for(var x in ttree){
				  ...
				  if(sel){
					  for(var y in list){
						  if(list[y].id == sel){
							matrix.push([list[y].descripcion]); 
							break;
						  }
					  }
				  }else{
	...
	openMetadataVar:function(_var){
		...
		var file='<iframe src="'+doc+'" width="100%" height="370px" class="cfepade-metadata-frame"></iframe>';
		...
		if(theme){
		 ...
		 //var graphObj = obj.crateGraphData(detail,title);	 //grafica anterior, bloquedas por el momento Marzo 2017
		  for (var x in detail){
			  var item = detail[x];
			   var color = colors[x]
			  cadena+= '<div class="cfepade-stratum-detail-item">';
			  cadena+= '	  	<div class="cfepade-stratum-detail-item-color" style="background-color:'+color+';"></div>';
			  cadena+= '	  	<div class="cfepade-stratum-detail-item-info">';
			  cadena+= '			<div class="cfepade-stratum-detail-item-info-vals">';
			  cadena+= '				<label class="cfepade-stratum-detail-item-info-label">Estrato</label>';
			  cadena+= '				<label class="cfepade-stratum-detail-item-info-value">'+item.stratum+'</label>';
			  cadena+= '			</div>';
			  cadena+= '			<div class="cfepade-stratum-detail-item-info-vals">';
			  cadena+= '				<label class="cfepade-stratum-detail-item-info-label">Frecuencia</label>';
			  cadena+= '				<label class="cfepade-stratum-detail-item-info-value">'+(item.cvegeo.length)+'</label>';
			  cadena+= '			</div>';
			  cadena+= '		</div>';
			  cadena+= '</div>';
		  }
		  //elementos extra
		      cadena+= '<div class="cfepade-stratum-detail-item">';
			  cadena+= '	  	<div class="cfepade-stratum-detail-item-color cfepade-confiden-bg"></div>';
			  cadena+= '	  	<div class="cfepade-stratum-detail-item-info">';
			  cadena+= '			<div class="cfepade-stratum-detail-item-info-vals special">';
			  cadena+= '				<label class="cfepade-stratum-detail-item-info-label">No aplica</label>';
			  cadena+= '			</div>';
			  cadena+= '		</div>';
			  cadena+= '</div>';
			  cadena+= '<div class="cfepade-stratum-detail-item">';
			  cadena+= '	  	<div class="cfepade-stratum-detail-item-color cfepade-confiden-bg-no"></div>';
			  cadena+= '	  	<div class="cfepade-stratum-detail-item-info">';
			  cadena+= '			<div class="cfepade-stratum-detail-item-info-vals special">';
			  cadena+= '				<label class="cfepade-stratum-detail-item-info-label">No se sabe</label>';
			  cadena+= '			</div>';
			  cadena+= '		</div>';
			  cadena+= '</div>';
			  cadena+= '<div class="cfepade-stratum-detail-item">';
			  cadena+= '	  	<div class="cfepade-stratum-detail-item-color" style="background-color:#FFF;border:1px solid #adadad"></div>';
			  cadena+= '	  	<div class="cfepade-stratum-detail-item-info">';
			  cadena+= '			<div class="cfepade-stratum-detail-item-info-vals special">';
			  cadena+= '				<label class="cfepade-stratum-detail-item-info-label">No contesto Cuestionario</label>';
			  cadena+= '			</div>';
			  cadena+= '		</div>';
			  cadena+= '</div>';
  ...
  openDialog:function(url,title){
	  var obj = this; 
		  ...
		  if(!$('#cfepade-Info-dialog').attr('id')){
			  var cadena = '<div title="'+title+'" id="cfepade-Info-dialog"><div id="cfepade-html-doc"></div></div>';
			  $('#panel-center').append(cadena);
			  $('#cfepade-Info-dialog').dialog({
				    dialogClass: 'cfepade-Info-dialogContainer',
					width:550,
					height:470,
				  	modal:true,
			  ...
			  $('#cfepade-Info-dialog').html('<div id="cfepade-html-doc"></div>').dialog();
		  }
	  
	  	  $('#cfepade-html-doc').load(url);
   },
...
//Control de ficha *********************************************************************************************************************
	...
	printCardChild:function(lvl,data,lvlcount){
		var obj = this;
		var list = data;
		lvlcount = (!lvlcount)?1:lvlcount;
		var cadena = '<table class="cfepade-table-color-childs" cellspacing=0 cellpadding=0>';
			cadena+= '<thead><tr><td class="fepade-child-num"></td></td><th>Indicador</th><th >Valor</th></tr></thead>';
			cadena+= '<tbody>';
		...
		for(var x in list){
			var item = list[x];
			var childs = (item.childlist)?item.childlist:null;
			var name = item.label;

			var scrollPointer = (!lvl)?'id="geoelectoral_ind_'+(count-1)+'" class="cfepade-card-title" ':'';

			var value = (item.value)?item.value:'';
				if(item.value || (!item.value && childs)){
					cadena+= '<tr '+scrollPointer+'></tr><td class="fepade-child-num">'+txtLvl+''+count+'</td><td>'+name+'</td><td class="fepade-child-val">'+value+'</td></tr>';
					if(childs){
						cadena+= '<td class="fepade-child-num"></td><td colspan=2>'+obj.printCardChild(txtLvl+count,childs,lvlcount+1)+'</td>';
					}
					count++;
				}
		}
	...
	valuesCardChild:function(lvl,data,lvlcount){
		var obj = this;
		var list = data;
		var txtLvl = (!lvl)?'':lvl+'.';
		var count = 1;
		...
		for(var x in list){
			...
			var name = item.label;
			if(item.value || (!item.value && childs)){
				print_list.push([(txtLvl+''+count)+' '+item.label,item.value]);
				if(childs){
						var _list = obj.valuesCardChild(txtLvl+count,childs,lvlcount+1);
						print_list = [...print_list, ..._list];
				}
				count++;
			}
		}
	...
	printCardData:function(data){
		...
		var dialogTitle = data.properties.title;
		
		if($('#toolcfepade_info').attr('id'))
			$('#toolcfepade_info').remove();
		
		
		var cadena = '<div id="toolcfepade_info" title="'+dialogTitle+'"><div id="toolcfepade_info_content"></div></div>';
			$("#panel-center").append(cadena);
		
		$('#toolcfepade_info').dialog({
			resizable:false,
			width:800,
			modal: true,
			height:585,
		...
		cadena = '<div id="cfepade_card_header"></div>';
		cadena+= '<div class="cfepade-card-title-indicators">Indicadores</div>';
		cadena+= '<div id="cfepade_card_indicators_container" class="cfepade-animated">';
		cadena+= '	<div id="cfepade_card_indicators_closebtn"><span class="sprite-cfepade-sleft"></span><span class="sprite-cfepade-sright"></span></div>';
		cadena+= '	<div id="cfepade_card_indicators"></div>';
		cadena+= '</div>';
		cadena+= '<div id="cfepade_card_values" class="cfepade-animated"></div>';
		cadena+= '<div id="cfepade_card_toolbar"></div>';
		
		$('#toolcfepade_info_content').html(cadena);
		
		
		//encabezado
		cadena = '<table class="cfepade-table-color">';
		...
		cadena+= '</tbody></table>';
		dataExport.push(['','']);
		$('#cfepade_card_header').html(cadena);
		...
		for(var x in list){
			var item = list[x];
			cadena+= '<li class="'+((x==0)?'active ':'')+'geoelectoral-card-var cfepade-animated" pos="'+x+'">';
			//cadena+= '	<div idref="'+item.field+'" class="ui-icon ui-icon-info cfepade-card-varid"></div>';
			cadena+= '	<label>'+item.label+'</label>';
			cadena+= '</li>';
			count++;
		}
		cadena+= '</ul>'
		$('#cfepade_card_indicators').html(cadena);
		
		$('.cfepade-card-varid').each(function(){
			$(this).click(function(){
				var idref = $(this).attr('idref');
			  	obj.openMetadataVar(idref);
			});
		...
		for(var x in list){
			var item = list[x];
				cadena+= '<div id="geoelectoral_ind_'+x+'" class="cfepade-card-block"><div pos="'+x+'" class="cfepade-card-title">'+count+'. '+item.label+'</div>';
				dataExport.push([item.label]);
				cadena+= 	'<div class="cfepade-card-blockcontent">';
				cadena+= 	'<table class="cfepade-table-color"><tbody>';
		...
		//$('#cfepade_card_values').html(cadena);
		*/

		var _cadena = obj.printCardChild(null,data.indicators);
		var _export  = obj.valuesCardChild(null,data.indicators);
		
		$('#cfepade_card_values').html(_cadena);
		dataExport = [...dataExport, ..._export];
		
		//Exportación
		var exportList = obj.settings.exportTypes;
		cadena = '';
		for(var x in exportList){
			cadena+='<div idref="'+exportList[x]+'" class="cfepade-card-export-type-item sprite-cfepade-doc-'+exportList[x]+'"></div>';
		}
		//inclusión de descarga nacional
		cadena+='</div>';
		
		$('#cfepade_card_toolbar').html(cadena);
		
		$('.cfepade-card-export-type-item').each(function(){
			$(this).click(function(){
				var idref = $(this).attr('idref');
	...
	setCardEvents:function(){
		...
		var jumpScrollToVar = function(pos){
			...
			$('#cfepade_card_values').animate({scrollTop:top}, 500, 'swing', function() { 
			});
		}
		$('.cfepade-card-title').each(function(){
		...
		$('#cfepade_card_values').scroll(function(){
			var scroll = $('#cfepade_card_values').scrollTop();
			for(var x in scrollpos){
				if((scrollpos[x]-scroll)>=0){
					if((scrollpos[x]-scroll) > $('#cfepade_card_values').height())
						x--;
		...
		$('.geoelectoral-card-var').each(function(){
			...
			$(this).click(function(){
				...
				*/
				...
				//$('#cfepade_card_values').scrollTop(top);
			})
		});
		
		$('#cfepade_card_indicators_closebtn').unbind('click');
		$('#cfepade_card_indicators_closebtn').click(function(){
			var status = $('#toolcfepade_info_content').attr('status');
			if(status != 'collapsed'){
				$('#toolcfepade_info_content').attr('status','collapsed');
			}else{
				$('#toolcfepade_info_content').attr('status','expanded');
			}
			setTimeout(function(){
				obj.setCardEvents();
	...
	loadTabulated:function(){ 
	  ...
	  var params = {
		  	...
		  	obj.getData(dataSource,params,function(data){
				  ...
				  var headers = {};
					cadena+= '<div class="cfepade-info-content-tabulate">';
					cadena+= '	<table style="width:100%;" id="cfepade_tabulador_table"><tr>';
				  ...
				  for(var x in list){
					  	  var row = list[x];
					  	  cadena+= '<tr class="cfepade-detail-data-row" '+((row.cvegeo)?' cvegeo="'+row.cvegeo+'" ':'')+'>';
						  for(var y in row){
						  	var val = row[y];
					...
					cadena+= '<tr>';
					cadena+= '<td class="cfepade-info-grid-container-note nohover" colspan="100">'+notes+'</td>';
					cadena+= '</tr>';  
					cadena+='</table>'
					...
					//cadena+='<div class="cfepade-info-grid-container-note">*Nota '+notes+'</div>'
					cadena+='</div>';
					$('#cfepade_info_tabulated_container').html(cadena);

					$('.cfepade-detail-data-row').each(function(){
						$(this).click(function(){
	...
	$('#cfepade_subvar_title').html('<div style="font-style:oblique">'+svars.join('<br/>')+'</div');
  ...
  printTutorial:function(){
    ...
    cadena+= '		</tr>';
    cadena+= '		<tr>';
    cadena+= '  		<td align="center" bgColor="#deb9b9">Documento metodológico</td>';
    cadena+= '  		<td>&nbsp;</td>';
    cadena+= '  		<td align="center" bgColor="#deb9b9">Manual de usuario</td>';
    cadena+= '		</tr>';
    cadena+= '		<tr>';
	cadena+= ' 			<td align="center"><a href="'+obj.settings.methodologicalDocument+'" target="_blank"><div id="cfepade_tab_pdfdoc" idref="pdfdoc" class="cfepade-resize sprite-cfepade-doc-pdf"></div></a></a></td>';
    cadena+= '  		<td>&nbsp;</td>';
	cadena+= ' 			<td align="center"><a href="'+obj.settings.userManual+'" target="_blank"><div id="cfepade_tab_pdfdoc" idref="pdfdoc" class="cfepade-resize sprite-cfepade-doc-pdf"></div></a></a></td>';
    cadena+= '		</tr>';
  	cadena+= '	</tbody>';
	cadena+= '</table>';
		
	$('#cfepade_tutorial_container').html(cadena);
},
	// Grafica
	createGraph: function (options) {
		...
		Highcharts.chart('cfepade_info_graph_container', {
...
//@ sourceURL=jquery.ui.cfepade.js