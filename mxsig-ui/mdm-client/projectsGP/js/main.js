	...
	init:function(){
		 var projectContext = require.config({
				...
				paths: {
					...
					inputNumber:'widgets/inputNumber/jquery.ui.inputNumber'
				...
				shim: {
					...
					main:{deps:['amaran','ecoPanel','panelList','userList','userPanel','colorSelector','dropDownImage','inputNumber']}
				}
			});
		 (function(){
			projectContext(['require','main'], function(require,main){
				...
				$.when(
					...
					$('<link>', {rel: 'stylesheet',type: 'text/css',href: 'projects/js/code/widgets/inputNumber/jquery.ui.inputNumber.css?'+urlArgs}).appendTo('head'),
