define(['OpenLayers','timer','modal','features','dataSource'],function(OL,Timer,Modal,Features,dataSource) {
	...
	m.left.push({label:'C&oacute;digo postal',value:data.codigoPostal,edit:true,id:'geoCP'});
	...
	b.left.push({label:'Nombre de entidad federativa',value:data.entidad});
	b.left.push({label:'Clave de entidad federativa',value:data.cveent});
