    ...
    getLayersDomList:function(){
      ...
      for (var x in list){
          ...
          for (var i in item){
              ...
              strLayer+= '<div class="layerDisplay-layer" id="'+obj.id+'_mLayer_'+idLayer+'">'+btnDisplay+'<label '+relLabelCheck+' id="'+obj.id+'_l_'+idLayer+'">'+((btnViewLayerData!='')?'<big><b>*</b></big>':'')+label+'</label>'+btnMetadato+btnScale+btnText+btnDownload/*+btnViewLayerData*/+'</div>';
		  ...
		  strGroup+= '	<div class="layerDisplay-title-container"><div class="layerDisplay-title">'+btnMetadatoGroup+'<div class="layerDisplay-groupLayer-name">'+btnThematicLink+labelGroup+'</div></div></div>'+strLayer;
