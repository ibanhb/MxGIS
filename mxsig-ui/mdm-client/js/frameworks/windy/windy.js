...
var Windy = function( params ){
  var VELOCITY_SCALE = 0.02;  // 0.011          // scale for wind velocity (completely arbitrary--this value looks nice)
  ...
  var PARTICLE_LINE_WIDTH = 0.5;//2              // line width of a drawn particle
  var PARTICLE_MULTIPLIER = 1/100;//1/30              // particle count scalar (completely arbitrary--this values looks nice)
  var PARTICLE_REDUCTION = 0.75;//0.75            // reduce particle count to this much of normal for mobile devices
  var FRAME_RATE = 20;//20                      // desired milliseconds per frame
  var BOUNDARY = 0.45;//0.45
