            ...
            var Events = {
                    ...
                    init : function( options ) {
                            var defaults = {
                                    ...
                                    'onZoomEnd':        $.noop,
                                    'onIdentify':       $.noop,
                                    'onDisplayFeatureMouseOver': $.noop,
                                    'onDrawFeature':$.noop,
                    ...
                    onDrawFeature:function(){
                        if(this.options!=null){
                            this.options.onDrawFeature.call(this,arguments[0]);
                        }
                    },
                    onDisplayFeatureMouseOver:function(){
                        if(this.options!=null){
                            this.options.onDisplayFeatureMouseOver.call(this,arguments[0]);
                        }
                    },
                    onZoomEnd:function(){
                        if(this.options!=null){
