...
requirejs.config({
                ...
                baseUrl: "js",
                paths: {
                    recursos: ['http://www.beta.inegi.org.mx/componentes/encabezado/js/recursos.min'],
                    encgenera: ['http://www.beta.inegi.org.mx/componentes/encabezado/js/enc_genera.min']
                },
                shim: {
                    encgenera: { deps: ['recursos'] }
                }
            });

            require(['recursos', 'encgenera'], function ($) {
                return {};
            });
